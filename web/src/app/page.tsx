		...
		<main className="max-w-[1240px] mx-auto px-5 py-8 md:py-0">
			<div className="min-h-dvh flex justify-center gap-16 flex-col">
				<div className="flex flex-col gap-8 items-center md:items-start">
					<Image src={logo} alt="Assistido" width={108.5} height={30} />

					<h1 className="text-4xl text-center leading-none font-medium font-heading flex flex-col md:text-7xl md:text-left">
				...
				<div className="flex gap-5 items-stretch flex-col md:flex-row">
					...
					<form className="bg-gray-700 border border-gray-700 rounded-2xl p-8 space-y-6 w-full md:max-w-[440px]">
						<h2 className="font-heading font-semibold text-gray-200 text-xl">
							Inscrição
						</h2>
